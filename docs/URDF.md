...
This document describes how the Drake-compatible URDF [`so101_new_calib_drake.urdf`](../models/SO101/so101_new_calib_drake.urdf) was prepared

## Source URDF

The source SO-101 URDF [`so101_new_calib.urdf`](../models/SO101/so101_new_calib.urdf) and associated model assets can be obtained from [the project page](https://github.com/TheRobotStudio/SO-ARM100/tree/main/Simulation/SO101). They are copied here for convenience.
